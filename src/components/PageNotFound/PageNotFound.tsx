...
export const PageNotFound = () : ReactElement => {
  ...
  return (
    <div className={styles.missing}>
      <h1 className={styles.missing__logo}>
        <svg className={styles.missing__icon} xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="45px" viewBox="0 0 24 24" width="45px" fill="#FFFFFF">
      ...
      <h2 className={styles.missing__msg}>Ups, Gdańsk not found</h2>
      <button className={styles.missing__button} onClick={() => navigate("/")}>
