...
export const Navbar = () => {
  ...
  const { setUser, currentUser, fetchUsers } = useContext(GlobalDataContext);
  ...
  return (
    <div className={styles.NavbarWrapper}>
      ...
      <div className={styles.logoutAvatarWrapper}>
        ...
        <svg onClick={handleLogOut} xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 0 24 24" width="35px" fill="#FFFFFF">
