...
export const LandingPage = () => {
	...
	const { setUser, setName, setUserDescription, name, userDescription } = useContext(AuthContext);
	...
	return (
		<div className={styles.wrapper}>
			<div className={styles.about}>
				...
				<p>
					Szukasz towarzysza do wspólnej aktywności? Dobrze trafiłeś! <br /> Niezależnie od tego czy chcesz iść poćwiczyć na siłownię czy szukasz
					przyjaciela do wspólnej nauki, <br /> GoGather ma dla ciebie towarzysza.
				</p>
			</div>
